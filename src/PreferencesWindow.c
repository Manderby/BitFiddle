...
NAWindow* createPreferencesWindow(){
  ...
  window = naNewWindow("Preferences", windowrect, NA_FALSE);
  ...
  showASCIIOnStartupCheckbox = naNewCheckbox(naTranslate(translatorGroup, BitFiddlePrefsShowASCII), naMakeRectS(40, 150, 220, 22));
  ...
  resetConversionOnStartupCheckbox = naNewCheckbox(naTranslate(translatorGroup, BitFiddlePrefsResetSettings), naMakeRectS(40, 128, 220, 22));
  ...
  keepMaxiOnTopCheckbox = naNewCheckbox(naTranslate(translatorGroup, BitFiddlePrefsMaxiVersion), naMakeRectS(40, 74, 220, 22));
  ...
  keepMiniOnTopCheckbox = naNewCheckbox(naTranslate(translatorGroup, BitFiddlePrefsMiniVersion), naMakeRectS(40, 52, 220, 22));
