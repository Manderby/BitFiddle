...
NA_LOC(BitLanguage,               "Idioma / Language / 言語 / Sprache");
NA_LOC(BitLanguageSameAsSystem,   "Mismo que el Sistema");
NA_LOC(BitLanguageReport,         "Reportar traducciones incorrectas...");
